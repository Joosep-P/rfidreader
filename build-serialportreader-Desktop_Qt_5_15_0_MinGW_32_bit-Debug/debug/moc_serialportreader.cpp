...
#include <memory>
#include "../../serialportreader/serialportreader.h"
...
QT_MOC_LITERAL(1, 17, 22), // "serialportDataReadDone"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 14) // "readSerialPort"

    },
    "SerialPortReader\0serialportDataReadDone\0"
    "\0readSerialPort"
};
...
void SerialPortReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->serialportDataReadDone(); break;
        case 1: _t->readSerialPort(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPortReader::serialportDataReadDone)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SerialPortReader::serialportDataReadDone()
{
